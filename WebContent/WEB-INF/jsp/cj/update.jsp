...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
    ...
    <form method="post" class="form-x" action="${ctx}/cj_exUpdate.do" id=""  enctype="multipart/form-data">   
    <input type="hidden" name="id" value="${Obj.id }">
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" id="code" value="${Obj.user.userName }" disabled="disabled" data-validate="required:请输入登录名" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="df" id="df" value="${Obj.df }" data-validate="required:请输入成绩" />         
          <div class="tips"></div>
        </div>
      </div> 
       <div class="form-group">
          ...
          <div class="field">
            <select name="xk.id" class="input w50">
     ...
     <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="submit" id=""> 提交</button>
        </div>
      </div>
    </form>
  </div>
